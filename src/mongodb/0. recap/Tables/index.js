...
/*
    ...
    🔹 Update a Collection in our database 🔹

    🔸 db.Collection-Name.delete() 🔸
    🔹 Delete a Collection in our database 🔹

    🔸 db.Collection-Name.aggregate() 🔸
    🔹 Aggregate a Collection in our database 🔹

    🔸 db.Collection-Name.updateOne() 🔸
    🔹 Update a single document in our database 🔹

    🔸 db.Collection-Name.updateMany() 🔸
    🔹 Update multiple documents in our database 🔹
*/


/*
    🔸 db.Collection-Name.deleteOne() 🔸
    🔹 Delete a single document in our database 🔹

    🔸 db.Collection-Name.deleteMany() 🔸
    🔹 Delete multiple documents in our database 🔹
*/
